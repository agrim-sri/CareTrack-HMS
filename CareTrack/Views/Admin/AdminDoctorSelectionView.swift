...
struct AdminDoctorSelectionView: View {
        ...
        ZStack{
            ...
            ScrollView(showsIndicators: false){
                ForEach(searchResults){ d in
                    NavigationLink(destination: AdminSlotBooksView(docID: d.id,docName: d.name, dept: d.department,rating: 4,qualification: d.Qualification,exp : d.Experience,id: id,name:name)) {
...
struct AdminDoctorSelectionView_Previews: PreviewProvider {
    static var previews: some View {
        AdminDoctorSelectionView()
    }
}
