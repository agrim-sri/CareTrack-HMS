...
struct AdminSlotBooksView: View {
        ...
        ZStack{
            ...
            ScrollView {
                VStack {
                    ...
                    AdminSlotBookView(docID: docID,docName: docName,degree:qualification, dept:dept,experience: exp,date: appointmentDate,id:id,name:name)
                }
    ...
    struct AdminSlotBooksView_Previews: PreviewProvider {
