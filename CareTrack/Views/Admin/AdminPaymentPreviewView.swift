...
struct AdminPaymentPreviewView: View {
    //     #F2F2F2
                ...
                VStack{
                    ...
                    HStack{
                        ...
                        Button {
                            ...
                            slotBookingVM.addData(doctorId: docID, patientId: id,doctorName: docname, department: dept, patientName: name, Date: date, slots: time)
                        } label: {
                            Text("Book Now")
                                .padding()
                                .foregroundColor(.white)
...
struct AdminPaymentPreviewView_Previews: PreviewProvider {
    static var previews: some View {
        AdminPaymentPreviewView()
    }
}
